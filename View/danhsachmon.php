    ...
    <div class="container">
        ...
        ?>
            <tr>
                ...
                <td><a class="link-light btn btn-primary  text-decoration-none" href="index.php?action=giaovien&act=caclopday&maMon=<?php echo $set['maMon'] ?>"><span class="h6"><i class="far fa-eye"></i> Xem </span></a></td>
            </tr>
