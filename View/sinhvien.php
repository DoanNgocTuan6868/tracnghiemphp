...
<section >
    <div class="container-fluid row">
        ...
        <h5 class="card-text-md-center text-danger mb-2" style="text-align: center;">Thời gian còn lại để bắt đầu thi :   <img src="Assets/img/dongho.jpg" width="35px; " style="padding-bottom:5px;" height="35px;" alt=""> <span id="timeRemaining"></span></h5>
            ...
            ?>
            <div class="card col-lg-3 col-md-3 col-border shadow"  style="width: 20rem;display:<?php echo $display; ?>;" >
            <img src="assets/img/anh10.png" height="100px" class="card-img-top" alt="...">
                ...
                <?php endif; ?>
                            ...
                            <!-- thời gian còn lại để bắt đầu thi -->
<script>
  function calculateTimeRemaining() {
    // Lấy thời gian hiện tại
    var now = new Date().getTime();

    // Lấy thời gian bắt đầu thi từ PHP
    var startTime = new Date("<?php echo $startTime; ?>").getTime();

    // Tính thời gian còn lại cho đến khi bắt đầu thi
    ...
    // Hiển thị thời gian còn lại để bắt đầu thi trong một phần tử HTML có id là "timeRemaining"
    document.getElementById("timeRemaining").innerHTML = hours + " giờ " + minutes + " phút " + seconds + " giây ";

    // Kiểm tra nếu đã đến thời gian bắt đầu thi
    if (timeRemaining <= 0) {
      clearInterval(interval);
      document.getElementById("timeRemaining").innerHTML = "Bắt đầu thi!";
    }
  }
